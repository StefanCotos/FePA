...
document.getElementById('forgot_form').addEventListener('submit', function (event) {
    ...
    fetch(window.location.origin + '/Web_Project/dispatchers/user_dispatcher.php/user/forgot', {
        method: 'POST',
        headers: {
                ...
                if (code === code_value) {
                    ...
                    document.getElementById('reset_form').addEventListener('submit', function (event) {
                        ...
                        if (password === confirmPassword) {
                            ...
                            fetch(window.location.origin + '/Web_Project/dispatchers/user_dispatcher.php/user', {
                                method: 'PUT',
                                headers: {
                                    'Content-Type': 'application/json'
                                },
